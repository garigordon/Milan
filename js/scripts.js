...
$(document).ready(function(){
   $('.products-loadmore').click(function(e){
      e.preventDefault();
      var $this = $(this);
      $this.find('i').addClass('spin-cc');
      setTimeout(function() {
...
$(document).ready(function(){
   $('.best-product .news-loadmore.new-products').click(function(e){
      e.preventDefault();
      var $this = $(this);
      $this.find('i').addClass('spin-cc');
      setTimeout(function() {
...
$(document).ready(function(){
   $('.news-loadmore.sales-products').click(function(e){
      e.preventDefault();
      var $this = $(this);
      $this.find('i').addClass('spin-cc');
      setTimeout(function() {
...
jQuery('.rslides .slider-container .slide-product > button').click(function(){
...
jQuery('.shop-style-list .style-list .list-item').click(function(e){
  e.preventDefault();
